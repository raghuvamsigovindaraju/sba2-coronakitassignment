...
<body>
	...
	<div class="col-sm-4">	
	<form:form  class="form" action='${isNew?pageContext.request.contextPath.concat("/admin/product-add"):pageContext.request.contextPath.concat("/admin/product-save")}' method="POST" modelAttribute="product">
